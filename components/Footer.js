    ...
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                <Image className="w-auto h-9" src="https://res.cloudinary.com/dysxcljt2/image/upload/v1693647958/education%20img/Layer_1_ah2lwx.png" alt="" width={1920} height={1920}/>

                <p className="text-base leading-relaxed text-gray-600 mt-7"> Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document </p>
        ...
        <p className="text-sm text-center text-gray-600">© Copyright 2024, All Rights Reserved by Dhruv Ambaliya</p>
    </div>
</section>
